...
btncomprobar.addEventListener('click', function() {
    ...
    if (numeroUsuario === NumeroGenerado) {
        resultado.textContent = '¡ EXCELENTE ! El número generado fue ' + NumeroGenerado + '. El número de intentos realizados fue ' + (Cont_intentos + 1);
        btncomprobar.disabled = true;
        cajanumero.disabled = true; // Deshabilita la caja de texto si se acierta
    } else {
        Cont_intentos++;
        intentos.textContent = 4 - Cont_intentos;
